    ...
    public partial class Form1 : Form
    {
        ...
        private async void Btn_Valider_Click(object sender, EventArgs e)
        {
            ...
            if (this.ValidateChildren())
            {
                ...
                //pour découpler et pour que l'application cliente travaille directement avec du json
                //avantage = pas besoin d'aller chercher la référence vers le projet Api

                //serialisation = transformation un objet en texte
                /* 
                ...
                /*
                // creation de l'objet à transmettre a l'api
                // DTO

                _01_Api_Rest.Models.Achat apiAchat = new()
                {
                    Id = "",
                    Nom = nouvelAchat.Nom,
                ...
                */
                ...
                //requete POST vers l'API (dans cet exo, l'api attend un objet qui provient de l'autre projet)
                Uri result = await ApiClient.CreateAchatAsync(nouvelAchat);


                //affichage résultat dans une autre fenêtre
