namespace _01_WF_ControlesEP
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            // buttonListe
            // 
            buttonListe.CausesValidation = false;
            buttonListe.Location = new Point(7, 163);
            buttonListe.Name = "buttonListe";
            buttonListe.Size = new Size(75, 23);
            buttonListe.TabIndex = 7;
            buttonListe.Text = "Liste";
            buttonListe.UseVisualStyleBackColor = true;
            buttonListe.Click += buttonListe_Click;
            // 
            // Form1
            // 
