...
<body>
    ...
    $objResto->searchAllJSON();       // méthode d'instance : obligé de créer un objet pour utiliser méthode (contrairement au méthode static (=méthode de classe) ou on a pas besoin d'insctancier un objet pour accéder à la méthode)                       
